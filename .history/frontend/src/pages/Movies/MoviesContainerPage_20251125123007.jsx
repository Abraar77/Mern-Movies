...
const MoviesContainerPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between items-center">
      <nav className=" w-[20rem] relative right-160 top-100  md:w-[10rem] ml-0 md:ml-2 mb-4 md:mb-0">
        {genres?.map((g) => (
          <button
            key={g._id}
      ...
      <section className="w-[100rem] relative bottom-100  left-15 md:w-[80%] mr-0 md:mr-2">
