...
const MoviesContainerPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between items-center">
      <nav className=" flex flex-col xl:flex-col lg:flex-col md:flex-row sm:flex-row  relative right-170">
        {genres?.map((g) => (
          <button
            key={g._id}
      ...
      <section className="flex flex-col justify-center items-center w-[20rem] lg:w-auto">
      <div className="w-full lg:w-[19rem] mb-8">
        ...
        <div className="w-full lg:w-[20rem] mb-8">
