        ...
        <div className="w-[73rem]">
            ...
            <div className="mt-[3rem]">
                ...
                <div className="container  flex justify-between ml-[20rem] mt-[2rem]">
                    ...
                    <div className="mr-[15rem] relative left-20 mt-6">
                        <p className="text-2xl font-semibold text-white flex w-[20rem]">
                            Releasing Date: {movie?.year}
                        </p>

                        <div className="mt-4 w-[20rem] flex gap-2 font-medium">
                            <p className=" font-bold text-2xl">Cast:</p> {movie?.cast.map((c) => (
                                <ul key={c._id}>
                                    ...
                                    >
                                        <li className="flex relative bottom-1 left-5 mt-1 underline">{c}</li> </a>
                                </ul>
                            ))}
                        </div>
                        <div className="flex justify-between flex-wrap text-white w-[20rem] mt-5 flex">
                        <Rating value={movie?.rating || 0} text={`${movie?.rating}/5 stars`} />
