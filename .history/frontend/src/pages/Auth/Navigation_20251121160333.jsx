    ...
    <div className="fixed bottom-10 left-[30rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-[2rem]">
          ...
          >
            <AiOutlineHome className="mr-2 text-white mt-[3rem]" size={26} />
          ...
          >
            ...
            <span className=" text-white nav-item-name mt-[3rem]">  Movies</span>
          </Link>
        </div>
        {/* Section 2 */}
          ...
          >
            ...
            {userInfo && (
              <svg
                ...
                className={`h-4 w-4 ml-1 cursor-pointer transform transition-transform duration-200 ${
                  dropdownOpen ? "rotate-450" : "rotate-0"
                }`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="white"
          ...
          {dropdownOpen && userInfo && (
            <ul
              className={`absolute right-0 mt-2 mr-14 w-[10rem] space-y-2 bg-white text-gray-600 ${
                !userInfo.isAdmin ? "-top-20" : "-top-30"
              }`}
            >
              {userInfo.isAdmin && (
                <>
          ...
          {!userInfo && (
            <ul className="flex">
              ...
              <li>
                <Link
                  to="/register"
                  className="flex items-center mt-5 transition-transform transform hover:translate-x-2 ml-[1rem]  text-white"
                >
